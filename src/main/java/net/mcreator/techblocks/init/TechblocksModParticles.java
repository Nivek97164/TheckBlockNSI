...
import net.mcreator.techblocks.client.particle.ParticulecorrumpuParticle;
...
public class TechblocksModParticles {
	private static final Map<ParticleType<?>, Function<SpriteSet, ParticleProvider<SimpleParticleType>>> REGISTRY = new HashMap<>();
	public static final SimpleParticleType PARTICULECORRUMPU = register(new SimpleParticleType(false).setRegistryName("particulecorrumpu"),
			ParticulecorrumpuParticle::provider);
