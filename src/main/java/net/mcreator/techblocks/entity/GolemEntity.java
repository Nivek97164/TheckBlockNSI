...
public class GolemEntity extends Monster {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.MONSTER).add(new MobSpawnSettings.SpawnerData(TechblocksModEntities.GOLEM, 20, 4, 4));
	}

	public GolemEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		this(TechblocksModEntities.GOLEM, world);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(TechblocksModItems.PLATINEINGOTE));
	}
	...
	public static void init() {
		SpawnPlacements.register(TechblocksModEntities.GOLEM, SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
